...
public class AdminDashboard extends Stage{
    ...
    private Scene accountsCreation;
    ...
    public AdminDashboard() throws IOException {
        ...
        accountsManagmentScene = new Scene(accountsRoot);
         ...
         //load AccountCreation FXML File in AccountsManagment Scene
        FXMLLoader accountsCreationLoader = new FXMLLoader(getClass().getResource("AdminFXML/CreateAccount.fxml"));
        Parent accountsCreatinRoot = accountsCreationLoader.load();     
        accountsCreation = new Scene(accountsCreatinRoot);
    ...
    public void changeSceneToAccountsCreation(){
        this.setScene(accountsCreation);
    }
